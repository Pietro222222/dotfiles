...
(setq user-full-name "pietro"
      user-mail-address "pietro.lima.queiroz@gmail.com")
...
(global-set-key (kbd "C-x C-k") 'mc/keyboard-quit)
(global-set-key (kbd "C-c C-r") 'recompile)
(global-set-key (kbd "C-M-c") 'comment-region)
(global-set-key (kbd "C-M-v") 'uncomment-region)
(global-set-key (kbd "C-S-u") 'undo)
(global-set-key (kbd "C-M-w") 'find-file-other-window)
